...
const APK_NAME = "apex-ea-v2.29.apk";
const GITHUB_RAW_CANDIDATES = [
  "https://raw.githubusercontent.com/trapgoatkaymow-sketch/apex-ea/main/public/apex-ea-v2.29.apk",
  ...
  "https://github.com/trapgoatkaymow-sketch/apex-ea/raw/main/public/apex-ea-v2.29.apk",
];

const LOCAL_CANDIDATES = [
  path.join(process.cwd(), "public", "apex-ea-v2.29.apk"),
  path.join(process.cwd(), "public", "apex-ea.apk"),
  path.join(process.cwd(), "public", "apex-ea-v2.28.apk"),
  path.join(process.cwd(), "apex-ea-v2.29.apk"),
  path.join(process.cwd(), "apex-ea.apk"),
  path.join(process.cwd(), "dist", "apex-ea-v2.29.apk"),
